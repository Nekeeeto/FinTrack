    ...
    <section className="relative overflow-hidden bg-background">
      <div className="py-14 sm:py-20 md:py-24 grid md:grid-cols-[1fr_1.6fr] gap-10 sm:gap-14 items-center">
        ...
        <div className="pl-5 sm:pl-6 max-w-xl mx-auto md:max-w-none md:mx-0 md:ml-auto lg:pl-[calc(50vw-512px)] pr-5 sm:pr-0 reveal">
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight text-foreground leading-tight">
            Todo lo que necesitás para{" "}
            <span className="text-[#5DBCD2]">controlar tus finanzas</span>
          </h3>
          <p className="mt-4 sm:mt-5 text-sm sm:text-base text-muted-foreground leading-relaxed max-w-md">
        ...
        <div className="relative reveal w-full overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 w-24 sm:w-40 bg-linear-to-l from-background via-background/80 to-transparent z-10 hidden md:block" />
                ...
                <article
                  ...
                  className={[
                    ...
                    isActive
                      ...
                      : "scale-[0.96] opacity-60 hover:opacity-100 hover:border-[#5DBCD2]/30 cursor-pointer dark:border-white/10 dark:hover:border-[#5DBCD2]/20",
                  ].join(" ")}
                  onClick={() => scrollTo(idx)}
                >
                  <div className="relative h-[220px] sm:h-[260px] md:h-[300px] w-full rounded-2xl overflow-hidden bg-slate-200/80 border border-border flex items-center justify-center p-4 dark:bg-black/50 dark:border-white/10">
                    <div className="absolute inset-0 bg-linear-to-bl from-white/40 to-transparent dark:from-white/[0.03]" />
                    
                    <div className="mx-auto flex h-full w-[170px] sm:w-[200px] flex-col overflow-hidden rounded-[1.5rem] border border-slate-300/80 bg-background shadow-lg shadow-slate-900/15 relative z-10 transition-transform duration-500 ease-out group-hover/article:scale-[1.03] dark:border-white/15 dark:bg-[#020617] dark:shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                      ...
                      {it.image ? (
                        ...
                        <div className="relative h-full w-full flex flex-col pt-10 px-3 pb-4">
                          <div className="w-full h-32 bg-muted/80 rounded-xl border border-border overflow-hidden relative dark:bg-white/5 dark:border-white/10">
                  ...
                  <div className="mt-6 sm:mt-8">
                    ...
                    <h4 className="mt-2 text-lg sm:text-xl font-bold text-foreground leading-tight">
                      {it.title}
                    </h4>
